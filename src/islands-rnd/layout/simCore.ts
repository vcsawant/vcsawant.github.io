...
//   - src/pages/rnd/layout.astro frontmatter (build time, Node)
//   - layout.worker.ts (runtime, Web Worker)
...
import { neighborsOf, type GraphData, type GraphEdge, type NodeKind } from './graph';
